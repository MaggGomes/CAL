...
void updateResults(const string &pattern, vector <T *> &vec, A func){
...
template <typename T, typename A>
void updateResultsAdvanced(const string &pattern, vector <T *> &vec, A func, unordered_map<string, T*> &unMap){
